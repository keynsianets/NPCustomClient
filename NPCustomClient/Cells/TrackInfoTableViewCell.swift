...
class TrackInfoTableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var sendCityLabel: UILabel!
    @IBOutlet weak var targetCityLabel: UILabel!
    ...
    func setData(trackInfo: TrackInfo?) {
        ...
        sendCityLabel.text = trackInfo.citySender
        targetCityLabel.text = trackInfo.cityRecipient
